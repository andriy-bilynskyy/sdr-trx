...
static struct {
    ...
    .header   = {
        .marker                 = 0xAD0CC0DE,
        .version                = 4                     /* !!! <- Increment on each app_settings_t modification */
    },
    /**************************************************************************
    ...
    .settings = {
        ...
        .codec_tx_line_sensitivity  = {.mute = false, .volume = 0x17},
        .codec_mic_sensitivity      = {.mute = false, .volume = 0x01},
        .hwctl_ext_mic              = false,
...
static volatile app_ctl_state_t app_ctl_state = {
    ...
    .codec_rx_line_sensitivity      = {.mute = false, .volume = 0x17}, /* adjustment during reception DSP process */
    .spectrum                       = {
        .valid = false,
        .iterarions = 0,
        .elements = 0,
