...
void widget_pwr_menu(app_handle_t * app_handle) {
    ...
    for(; app_handle->system_ctive;) {
        ...
        ui_engine_button(WIDGET_PWR_MENU_TAG_REBOOT,   (ui_engine_xsize - 120) / 2, 50,  180, 40, UI_ENGINE_FONT30, "Reboot");
        ui_engine_button(WIDGET_PWR_MENU_TAG_SHUTDOWN, (ui_engine_xsize - 120) / 2, 120, 180, 40, UI_ENGINE_FONT30, "Shutdown");
        ui_engine_button(WIDGET_PWR_MENU_TAG_EXIT,     (ui_engine_xsize - 120) / 2, 190, 180, 40, UI_ENGINE_FONT30, "Cancel");
